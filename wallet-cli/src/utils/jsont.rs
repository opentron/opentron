...
use proto::core::{
    ...
    ShieldedTransferContract, TransferAssetContract, TransferContract, TriggerSmartContract, UpdateAssetContract,
    UpdateEnergyLimitContract, UpdateSettingContract, VoteWitnessContract, WithdrawBalanceContract,
